...
buttons = [
    ...
    [     InlineKeyboardButton(
            text="Anime", url="https://t.me/anime_warz"),
    
    ],
    [
        InlineKeyboardButton(
            text="Chat Group", url="https://t.me/bestwalefriends"),
    ],
    [
        InlineKeyboardButton(
            text="Support", url="https://t.me/Levi_Support"),
          


InlineKeyboardButton(
            text="Owner", url="https://t.me/asta_silva_02"
        ),

    ],
    [
        InlineKeyboardButton(
                    text="🗄️ Source Code", url="https://te.legra.ph/file/d10893d91fa49a2956630.jpg"
        ),
    ],
]
...
HELP_STRINGS = """
`Hey there! My name is` [Levi Ackerman]("https://te.legra.ph/file/5f306817f9d0c0b567f20.jpg") 
I'm an Ackerman and help admins manage their groups with Some Powerful Titans! `Have a look at the following for an idea of some of the things I can help you with.`"""
...
def gabi_about_callback(update, context):
    ...
    if query.data == "gabi_":
        query.message.edit_text(
            text=""" ℹ️ I'm *Levi*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \nHere is the [💾Repository](https://te.legra.ph/file/d10893d91fa49a2956630.jpg).
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..👩‍💼 I'm *Levi*
                 \nHere is the [Source Code](https://te.legra.ph/file/d10893d91fa49a2956630.jpgIf) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
